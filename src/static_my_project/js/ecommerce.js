$(document).ready(function(){
  ...
  // var addressFormMethod=addressForm.attr("method")
  // var addressFormEndPoint=addressForm.attr("action")
  ...
  //   event.preventDefault()
  //   var addressFormSubmitBtn=addressForm.find("[type='submit']")
  //   var addressFormSubmitBtnTxt=addressForm.text()
  //   var addressFormData=addressForm.serialize()
  //   var thisForm=$(this)
  //   $.ajax({
  //     method:addressFormMethod,
  //     url:addressFormEndPoint,
